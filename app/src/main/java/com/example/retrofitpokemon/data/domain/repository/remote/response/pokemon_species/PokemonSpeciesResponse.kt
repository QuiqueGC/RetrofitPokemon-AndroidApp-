...
data class PokemonSpeciesResponse(
    ...
    @SerializedName("evolves_from_species") var evolvesFromSpecies: Any?,
    @SerializedName("flavor_text_entries") var flavorTextEntries: ArrayList<FlavorTextEntriesResponse>?,
    @SerializedName("form_descriptions") var formDescriptions: ArrayList<Any>?,
    ...
    @SerializedName("generation") var generation: GenerationResponseFromSpecies?,
